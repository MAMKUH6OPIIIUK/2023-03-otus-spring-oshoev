...
public class TestingServiceImpl implements TestingService {
    ...
    public static final String STUDENT_NAME_PROMPT_CODE = "testing.service.prompt.name";

    public static final String STUDENT_SURNAME_PROMPT_CODE = "testing.service.prompt.surname";
