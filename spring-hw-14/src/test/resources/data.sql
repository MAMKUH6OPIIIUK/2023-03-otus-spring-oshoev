...
insert into genres(genre_id, name) values (1, 'Жанр1');
insert into genres(genre_id, name) values (2, 'Жанр2');
insert into genres(genre_id, name) values (3, 'Жанр3');
...
insert into comments(id, text, book_id) values (1, 'Коммент1', 1);
insert into comments(id, text, book_id) values (2, 'Коммент2', 1);
insert into comments(id, text, book_id) values (3, 'Коммент3', 2);
